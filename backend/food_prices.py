...
_DELHI = [
    ...
    Place("Rajinder Da Dhaba", "Safdarjung Enclave", "Delhi", (NORTH,), 800, ("fabhotels-delhi",)),
    ...
    Place("Pind Balluchi", "Multiple", "Delhi", (NORTH, MUGHLAI), 1300, ("fabhotels-delhi",)),
    ...
    Place("Indian Accent", "Lodhi Road", "Delhi", (FUSION,), 5000, ("fabhotels-delhi",)),
    Place("Spice Route", "Janpath", "Delhi", (ASIAN, SEAFOOD), 6000, ("fabhotels-delhi",)),
    Place("Bukhara", "Chanakyapuri", "Delhi", (MUGHLAI, NORTH), 6500, ("fabhotels-delhi",)),
]
