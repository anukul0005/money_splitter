...
export default function MasterGroupCard({ master }) {
  ...
  return (
    <button
      ...
      className="col-span-1 md:col-span-2 card w-full flex items-center gap-3 active:scale-[0.98] transition-transform border-brand-300 bg-brand-50/40 text-left"
    >
